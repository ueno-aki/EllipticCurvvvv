...
fn secp256k1() {
    let secp256k1 = EllipticCurve{
        ...
        d: BigInt::parse_bytes(
            b"bb7bff1091c3622dab0c27ad438703b56a3be7ea763c8e6ffd1ebba7edf84427",
           16,
        )
        .unwrap(),
    };
    ...
    println!(
        "{}",
        match secp256k1.gen {
            Point::Exact(x, y) => format!("x:{},y:{}", x, y),
            Point::Infinity => format!("Infinity"),
        }
    )
}
...
fn secp384r1() {
    let secp384r1 = EllipticCurve{
        ...
        .unwrap(),
        d: BigInt::parse_bytes(
            b"ffffffffffffffffffffffffffffffffffffffffffffffffc7634d81f4372ddf581a0db248b0a77aecec196accc52974",
           16,
        )
        .unwrap(),
    };
    let p = secp384r1.calc_dP();
